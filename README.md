...
When submitting changes, please [create a merge request](https://gitlab.com/homelab-mods/LabBot/-/merge_requests/new) (using the `bot-cog` template) targetting the develop branch.
